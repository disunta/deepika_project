...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements com.kmp.CalculatorService {
    ...
    private java.lang.String Calculator_address = "http://localhost:8080/WebServiceProject/services/Calculator";
    ...
    public com.kmp.Calculator getCalculator() throws javax.xml.rpc.ServiceException {
    ...
    public com.kmp.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.kmp.CalculatorSoapBindingStub _stub = new com.kmp.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.kmp.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                com.kmp.CalculatorSoapBindingStub _stub = new com.kmp.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://kmp.com", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://kmp.com", "Calculator"));
        }
